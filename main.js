...
let divCarrito = document.getElementsByClassName("container-carts-products");

btnComprar.addEventListener("click", alerta);
...
let btnAgregar = document.getElementsByClassName("btn-add-cart");

for(i of btnAgregar){

i.addEventListener ("click", alerta1)
